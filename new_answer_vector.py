...
def get_vector_one_prime(A, n, max_length=None, prime=2):
    """
    Input is a DFA A and a positive integer n, which 
    is equal to the number of states of A. Output is 
    a list of size prime, where 
    prime is a prime number. max_length is the 
    ...
    if (A.accepts_input('')):
        ...
        # update the coordinates for the prime
        coord[curr_number % prime] = coord[curr_number % prime] + 1
